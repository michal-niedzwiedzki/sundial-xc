...
function confirmation($cid)
{
    ...
    {
        return "This system isn't setup to charge service fees.";
    }
    ...
    $html = <<<ENDHTML
        ...
        <form method="GET" action="">
          ...
          <table><tr><td>
          <b>Amount</b></td><td> <input type="text" name="amount" size=4 maxlength=5></tr>
          <tr><td> 
          <b>Fee Description</b></td><td> <textarea name="desc" rows=2 cols=40 maxlength=255>Service Fee</textarea></tr></table>
        
<p><input type="submit" value="Transfer now" />
        </form><p><strong>Or</strong></p>
...
function transfer_fee($tid)
{
    ...
    if (!is_numeric($fee))
    	return "The fee entered must be numeric (e.g. '5') and contain no other characters (e.g. '5 units' = bad input!)";
